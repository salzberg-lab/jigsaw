...
//////////////////////////////////////////////////////////////////////////////
#ifndef PHATFACTORY_H
#define PHATFACTORY_H
 ...
 * @stereotype factory 
 */
class PhatFactory : public DataSetAbstractFactory {
public:
...
private:
  static DataSetAbstractProduct* gffHomologyRead(ifstream&,const string&, const std::string&);
