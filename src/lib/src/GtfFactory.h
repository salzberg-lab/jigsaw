 ...
 * @stereotype factory 
 */
class GtfFactory : public DataSetAbstractFactory {
public:
...
private:
  static DataSetAbstractProduct* gtfHomologyRead(std::ifstream&,const string&, const std::string&);
  static DataSetAbstractProduct* gtfCuration(std::ifstream&,const string&, const std::string&);
